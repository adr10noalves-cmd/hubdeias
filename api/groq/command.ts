...
Se a IA destino for informada (ex: Claude, ChatGPT, DeepSeek, Gemini, Cursor), adapte a sintaxe e melhores práticas daquela IA (ex: tags XML e raciocínio para Claude, markdown denso para ChatGPT, passos de validação para Cursor) mantendo SEMPRE em Português do Brasil.
